...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Alexander 维度', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '抽象艺术家😈', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.wuhoo.tech', // 网站地址
